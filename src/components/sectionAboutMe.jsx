            ...
            <section className='containerAllInformation'>
              <div className='containerHabilities'>
                ...
                <div className='habilities'>
                  ...
                  <Zoom delay={1900} triggerOnce ><span className='eachHability'>REACT NATIVE</span></Zoom>
                  <Zoom delay={1900} triggerOnce ><span className='eachHability'>NODE.JS</span></Zoom>
                </div>
              </div>
              <div className='containerCompetence'>
                ...
                <div className='competences'>
                  ...
                  <Zoom delay={1300} triggerOnce><span className='eachCompetence'>TRABAJO EN EQUIPO</span></Zoom>
                  <Zoom delay={1600} triggerOnce><span className='eachCompetence'>HABILIDAD RESOLUTIVA</span></Zoom>
                </div>
              </div>
              <div className='containerKnowledge'>
                ...
                <div className='knowledges'>
                  ...
                  <Zoom delay={1000} triggerOnce><span className='eachKnowledge'>TRELLO</span></Zoom>
                  <Zoom delay={1300} triggerOnce><span className='eachKnowledge'>FIGMA</span></Zoom>
                </div>
              </div>
            </section>
          </div>
